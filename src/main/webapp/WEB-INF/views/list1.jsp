...
<label class="radio-inline">
  <input type="radio" name="gender" id="gender2_add_input" value="F"> 女
	...
	function reset_form(ele) {
		//清除表单数据(表单重置(表单的数据，表单的样式))(reset方法是dom对象的，jqery没有)
		$(ele)[0].reset();
		//清空表单样式
	...
	$("#emp_save_btn").click(function(){
		...
		//4.发送ajax请求保存员工
		//Jquery提供的一种serialize()方法能够返回提交的信息
		$.ajax({
			url:"${APP_PATH}/emp",
			type:"POST",
	...
	function getEmp(id){
		$.ajax({
			...
			success:function(result){
				//console.log(result);
				//{"code":100,"msg":"处理成功!","extend":{"employee":{"empId":1,"empName":"jerry","gender":"M","email":"jerry@qq.com","dId":1,"department":null}}}
